...
//    maxRepetitionsRK78: maximum number of repetitions of the RK78 algorithm allowed before throwing an error
...
//    otherwise: error
// ----------------------------------------------
int rk78(double *t, double x[], double *h, double hmin, double hmax, double tol, int maxRepetitionsRK78, int n, int (*field)(int n, double t, double x[], double f[], void *param), void *param);
...
//    IMPORTANT REMARK: if we want ot integrate backwards in time, we should have *h < 0, hmax < hmin < 0 and of course T < 0
//
// Parameters:
