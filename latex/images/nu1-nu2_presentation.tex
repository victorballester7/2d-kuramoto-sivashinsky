...
\begin{tikzpicture}[scale=\scale]
  ...
  \begin{axis}[
      ...
      legend style={at={(0.96, -0.3)}, anchor=north, legend columns=3, fill=none,transpose legend,/tikz/every even column/.append style={column sep=0.2cm},legend image post style={scale=\scale}},
