...
\begin{tikzpicture}[scale=2.1]
  ...
  \begin{axis}[
      ...
      legend style={at={(0.25, 0.46)}, anchor=north, legend columns=3, fill=none, font=\small,transpose legend,/tikz/every even column/.append style={column sep=0.2cm},legend image post style={scale=2}},
